...
import { CostosPaquete } from './Paquete'

export const paqueteGrow: CostosPaquete = {
    nombre: 'Grow',
    costos: {
        // implementacion
...
export const paqueteInstitutional: CostosPaquete = {
    ...
    costos: {
        ...
        costoUsuarioExtraDespuesDeLimite: 716,
        // timbres
        costoTimbreExtra: 1,
        // razon social
        costoRazonSocial: 'Paquetes de 1000',
...
export const paqueteManufacturing: CostosPaquete = {
...
export const paqueteEnterprise: CostosPaquete = {
    nombre: 'Enterprise',
    costos: {
        // implementacion
...
export const paqueteInternationalEnterprise: CostosPaquete = {
    ...
    costos: {
        ...
        costoUsuarioExtraDespuesDeLimite: 'Contacta a ventas',
        // timbres
