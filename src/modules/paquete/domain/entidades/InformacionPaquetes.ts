...
import { InformacionPaquete } from './Paquete'

export const paqueteGrow: InformacionPaquete = {
    limites: {
        maxUsuarios: 14,
        maxSucursales: 2,
        maxEmpleados: 29,
...
export const paqueteInstitutional: InformacionPaquete = {
    limites: {
        maxUsuarios: 29,
        maxSucursales: 10,
        maxEmpleados: 99,
...
export const paqueteManufacturing: InformacionPaquete = {
    limites: {
        maxUsuarios: 99,
        maxSucursales: 15,
        maxEmpleados: 299,
...
export const paqueteEnterprise: InformacionPaquete = {
    limites: {
        maxUsuarios: 499,
        maxSucursales: 100,
        maxEmpleados: 999,
    ...
    capacitacion: {
        diasDeAsesorCapacitacion:
            'Arquitecto de exito asignado </br> para garantizar la transformacion',
        usuariosIncluidosCapacitacion: 20,
    ...
    soporte: {
        ...
        via: 'Email, Whatsapp y Videollamada',
        horarioAtencion: 'Lunes a Viernes de </br> 24/7 **',
        upTime: '99.49%',
...
export const paqueteInternationalEnterprise: InformacionPaquete = {
    limites: {
    ...
    soporte: {
        ...
        via: 'Email, Whatsapp y Videollamada',
        horarioAtencion: 'Lunes a Viernes de 24/7 **',
        upTime: '99.68%',
