...
import { CostosPaquete } from '../domain/entidades/Paquete'
import { AtributosDinamicosPaquetes } from '../domain/entidades/Paquete'
...
export function getAllCostosPaquete(
    ...
    atributosDinamicosPaquetes: AtributosDinamicosPaquetes
) {
    const costoImplementacion = calcularCostoImplementacion(
        paquete.costos.costoActivacion,
        paquete.costos.costoMigracion,
        paquete.costos.costoCapacitacion,
        paquete.regalos.descuentoPorSeleccionUnPagoDeImplementacion,
        atributosDinamicosPaquetes.isPagoImplementacionMensual
    )

    const costoMembresia = calcularCostoMembresia(
        paquete.costos.costoBaseMensual,
        paquete.regalos.mesesDeRegaloPorSeleccionUnPagoDeMembresia,
        atributosDinamicosPaquetes.isPagoMensualidadMensual
    )
    ...
    const costoTimbres = calcularCostoTimbres(
        atributosDinamicosPaquetes.timbresRequeridos,
        paquete.regalos.timbresGratisIncluidos,
        paquete.costos.costoTimbreExtra
    )

    const costoUsuarios = calcularCostoUsuario(
        atributosDinamicosPaquetes.usuariosRequeridos,
        paquete.regalos.usuariosGratisIncluidos,
        paquete.costos.costoUsuarioExtra,
        atributosDinamicosPaquetes.hasPrecioVariable
    )
